...
resource "azurerm_network_security_group" "container_apps" {
  name                = "nsg-ca-${var.name}"
  location            = var.location
  resource_group_name = var.resource_group_name
  tags                = var.tags
}

resource "azurerm_network_security_rule" "container_apps_inbound" {
...
resource "azurerm_network_security_rule" "container_apps_outbound" {
